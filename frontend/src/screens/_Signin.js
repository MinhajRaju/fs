...
const mapStateToProps = (state) =>{
  ...
  return {CustomerInfo:state.CustomerLoginReducers.CustomerInfo}
...
export default connect(mapStateToProps)(class Signin extends React.Component{
  ...
  <section class="my-lg-14 my-8">
    <div class="container">
      ...
      <span><i id="passwordToggler"class="bi bi-eye-slash"></i></span>
              ...
              <div class="col-12 d-grid"> <button type="submit" onClick={(e)=> this.submit(e)} class="btn btn-primary">Sign In</button>
              </div>
