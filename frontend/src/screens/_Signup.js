...
import { RegisterCustomerAction } from "../Actions/actions";

const mapStateToProps = (state) =>{

  return {Register:state.RegisterCustomerReducers.RegisterCustomerState}

}



export default connect(mapStateToProps)(class Signup extends React.Component{
    ...
    submit =  (e) =>{
      e.preventDefault()
      store.dispatch(RegisterCustomerAction(this.state.name,this.state.number,this.state.email,this.state.pass))
        ...
        <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
          ...
          <form>
            <div class="row g-3">
              ...
              <div class="col">
                <input onChange={(e) => this.setState({name:e.target.value})} type="text" class="form-control" placeholder="Name" aria-label="First name"
                  required />
              </div>
          
              <div class="col-12">

<input onChange={(e) => this.setState({number:e.target.value})} type="number" class="form-control" id="inputEmail4" placeholder="Phone number" required />
</div>
              <div class="col-12">
              ...
              <div class="col-12 d-grid"> <button type="submit" onClick={(e)=>this.submit(e)} class="btn btn-primary">Register</button>
              </div>
